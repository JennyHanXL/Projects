---
title: "Analysis and Forecasting of Median Price of single family homes in Sacramento"
...
At seasonal level, the ACF tails off, the PACF has a small lag on the first seasonal lag which indicates either a weak seasonality or it is caused by sample variation. Therefore, we can regard PACF as cutting of at the first lag. We include seasonal ARIMAs(1,0,0) as a candidate model.
